const projectsData = [
  {
    id: 1,
    title: 'Tangled Web',
    label: 'Go to Tangled Web Game',
    description:
      'Help Spiderman to untangle his web. Single Page Application made with React. No additional libraries apart from webpack packages.',
    imageUrl: '../images/tangled-web.jpg',
    link: 'https://tangled-web.netlify.app/',
    githubLink: 'https://github.com/dmcoding1/tangled-web-spa',
    tools: [
      'html5',
      'css3',
      'sass',
  ...
  },
  {
    ...
    link: 'https://christmas-cards-generator.netlify.app/',
    githubLink: 'https://github.com/dmcoding1/Christmas-Card-Generator',
    figmaLink:
      'https://www.figma.com/proto/U0dxKIPpmw13zZywOdKmzI/Christmas-Card-Generator?node-id=76%3A4&scaling=scale-down',
    tools: [
      'html5',
      'css3',
      'sass',
  ...
  },
  {
    ...
    link: 'https://musical-scales.netlify.app/',
    githubLink: 'https://github.com/dmcoding1/Scales-App',
